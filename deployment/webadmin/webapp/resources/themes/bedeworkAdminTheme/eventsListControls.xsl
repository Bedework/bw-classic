  ...
  <xsl:template name="eventListControls">
    ...
    <xsl:if test="/bedework/events/event">
      <div class="bwEventListNav">
        ...
        <button type="button" class="prev" onclick="location.href='{$nextAction}&amp;prev=prev&amp;sort=dtstart.utc:asc'">
        ...
        <button type="button" class="next" onclick="location.href='{$nextAction}&amp;next=next&amp;sort=dtstart.utc:asc'">
