    ...
    <div id="bwEventListControls">
      ...
      <form name="bwManageEventListControls"
        ...
        <div class="container-nowrap">
          ...
          <select name="colPath"
                  onchange="setListCal(this.form,this.value);"
                  id="colPathSetter">
        ...
        <div class="container-nowrap">
          ...
          <select name="catFilter"
                  onchange="setListCat(this.form,this.value);"
          ...
          <xsl:if test="/bedework/appvar[key='catFilter'] and /bedework/appvar[key='catFilter']/value != ''">
            <input type="button" value="{$bwStr-EvLs-ClearFilter}" onclick="setListCat(this.form,'');"/>
          </xsl:if>
        </div>
      </form>
    </div>
