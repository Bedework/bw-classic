<xsl:stylesheet
  ...
  <xsl:variable name="bwStr-HdBr-SchoolOfEngineeringHome">00School of Engineering Home</xsl:variable>
  <xsl:variable name="bwStr-HdBr-SchoolOfEngineering">00School of Engineering</xsl:variable>
  ...
  <xsl:variable name="bwStr-SrcB-Calendar">00Calendar:</xsl:variable>
  ...
  <xsl:variable name="bwStr-EvCG-TentativeColon">00TENTATIVE:</xsl:variable>
  ...
  <xsl:variable name="bwStr-Cals-ExportCalendar">00Export Calendar</xsl:variable>
