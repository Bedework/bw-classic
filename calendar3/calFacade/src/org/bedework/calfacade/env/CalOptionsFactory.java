 ...
 *
 */
public class CalOptionsFactory {
  private final static String envclass = "org.bedework.calenv.CalOptions";
  ...
  */
  public static CalOptionsI getOptions(String appPrefix, boolean debug) throws CalEnvException {
    try {
      ...
      if (!(o instanceof CalOptionsI)) {
        throw new CalEnvException("Class " + envclass +
                                  " is not a subclass of " +
                                  CalOptionsI.class.getName());
      }

      CalOptionsI options = (CalOptionsI)o;

      options.init(appPrefix, debug);
