...
/>
  ...
  <xsl:variable name="initUpload" select="/ucalendar/urlPrefixes/initUpload"/>
  <xsl:variable name="upload" select="/ucalendar/urlPrefixes/upload"/>
    ...
    <html lang="en">
      ...
      <body>
        ...
        <xsl:choose>
          ...
          <xsl:when test="/ucalendar/page='upload'">
        ...
        <table border="0" cellpadding="0" cellspacing="0" id="tabsTable">
          <tr>
            ...
            <td class="rssPrint">
              ...
              <a class="rss" href="{$selectCalendar}?calId=&amp;setappvar=summaryMode(details)&amp;skinName=rss" title="RSS feed">RSS</a>
            </td>
            <td>
              <xsl:choose>
                <xsl:when test="/ucalendar/periodname='Day'">
              ...
              <tr>
                ...
                <td class="smallIcon">
                  ...
                  <a href="{$eventView}?subid={$subscriptionId}&amp;guid={$guid}&amp;recurrenceId={$recurrenceId}&amp;nocache=no&amp;skinName=ical&amp;contentType=text/calendar&amp;contentName={$icalName}" title="Download event as ical - for Outlook, PDAs, iCal, and other desktop calendars">
                    <img src="{$resourcesRoot}/images/demo/std-ical-icon-small.gif" width="12" height="16" border="0" align="left" alt="Download event as ical - for Outlook, PDAs, iCal, and other desktop calendars"/>
                  </a>
                </td>
              </tr>
            </xsl:for-each>
