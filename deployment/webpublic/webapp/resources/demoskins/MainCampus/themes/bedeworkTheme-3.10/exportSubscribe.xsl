...
<xsl:stylesheet
  ...
  <xsl:template name="exportSubscribe">
    ...
    <div id="exportSubscribeForm">
      <h3><xsl:copy-of select="$bwStr-exSu-FeedOrWidget"/></h3>
      ...
      <div id="bwExpDataFormat">
        <h3><xsl:copy-of select="$bwStr-exSu-DataFormat"/></h3>
        <ul>
          <li>
      ...
      <div id="bwExpCount">
        <h3><xsl:copy-of select="$bwStr-exSu-EventCount"/></h3>
      ...
      <div id="bwExpTimeframeUnit">
        <h3><xsl:copy-of select="$bwStr-exSu-Timeframe"/></h3>
        <ul id="bwExpTimeFrameWidgets">
          ...
          <li>
            ...
            <label for="bwExpNumberOfDays"><xsl:copy-of select="$bwStr-exSu-LimitTo"/><xsl:text> </xsl:text><input class="slider" onclick="updateUrlDisplay();" type="text" size="3" id="bwExpNumDays"/><xsl:text> </xsl:text><xsl:copy-of select="$bwStr-exSu-DaysFromToday"/></label>
            <div class="bwExpSubField">
          ...
          <li>
            ...
            <label for="bwExpStartEndDates"><xsl:copy-of select="$bwStr-exSu-DateRangeColon"/>
              <span class="bwExpSubField">
                <xsl:copy-of select="$bwStr-exSu-StartDateColon"/><xsl:text> </xsl:text><input size="8" class="datepicker" id="bwExpStartDate" onclick="updateUrlDisplay();" type="text"></input>
                <xsl:text> </xsl:text>
                <xsl:copy-of select="$bwStr-exSu-EndDateColon"/><xsl:text> </xsl:text><input size="8" class="datepicker" id="bwExpEndDate" onclick="updateUrlDisplay();" type="text"></input>
              </span>
            </label><br/>
      ...
      <div id="bwExpJsWidgetOptions">
        ...
        <h3><xsl:copy-of select="$bwStr-exSu-WidgetOptions"/></h3>
      ...
      <div id="bwExpURL">
        <p class="bwExpOutput">
          ...
          <a href="" id="bwExpUrlBox" target="_blank"><xsl:text> </xsl:text></a>
        </p>
      </div>
