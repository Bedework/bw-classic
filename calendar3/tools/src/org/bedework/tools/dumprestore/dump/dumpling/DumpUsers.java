...
public class DumpUsers extends Dumpling {
  ...
  private void dumpUser(BwUser u) throws Throwable {
    ...
    taggedEntityId(u);
    taggedVal("account", u.getAccount());
    taggedVal("created", u.getCreated());
    taggedVal("logon", u.getLogon());
    taggedVal("lastAccess", u.getLastAccess());
    taggedVal("lastModify", u.getLastModify());
    taggedVal("category-access", u.getCategoryAccess());
    taggedVal("location-access", u.getLocationAccess());
    taggedVal("sponsor-access", u.getSponsorAccess());
