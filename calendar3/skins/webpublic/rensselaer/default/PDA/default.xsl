...
/>
  ...
  <xsl:template match="event">
    ...
    <p align="center">
      ...
      <xsl:variable name="vcalName" select="concat($id,'.vcs')"/>
      <b>
        <a href="{$urlPrefix}/eventView.do?eventId={$id}&amp;nocache=no&amp;skinName=vcal&amp;contentType=text/calendar&amp;contentName={$vcalName}" title="Download event as vCal">
          Download this Event
        </a>
      </b>
    </p>
