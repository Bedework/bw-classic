...
locLdapContainer='ou=locations,dc=berkeley,dc=edu'
peopleLdapContainer='ou=locations,dc=berkeley,dc=edu'
...
objectclass: organizationalUnit"locLdapContainer='ou=locations,dc=berkeley,dc=edu'
peopleLdapContainer='ou=locations,dc=berkeley,dc=edu'
