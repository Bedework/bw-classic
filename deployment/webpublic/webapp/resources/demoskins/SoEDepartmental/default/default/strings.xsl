<xsl:stylesheet
  ...
  <xsl:variable name="bwStr-HdBr-SchoolOfEngineeringHome">School of Engineering Home</xsl:variable>
  <xsl:variable name="bwStr-HdBr-SchoolOfEngineering">School of Engineering</xsl:variable>
  ...
  <xsl:variable name="bwStr-EvCG-TentativeColon">TENTATIVE:</xsl:variable>
  ...
  <xsl:variable name="bwStr-Cals-ExportCalendar">Export Calendar</xsl:variable>
