...
<xsl:stylesheet
  ...
  <xsl:variable name="bwStr-CuCa-SharingMayBeAdded">Puede añadirse compartición a una agenda una vez ha sido creada.</xsl:variable>
